...
const Mainlayout = () => {
  ...
  return (
    <div className="relative">
      ...
      <main
  className={`bg-[#CDD8FF] pt-[80px] transition-opacity duration-700 ${
...
>
      ...
      <div
        ...
        className="fixed bottom-5 right-5 bg-[#a786f3] rounded-full shadow-lg z-10 cursor-pointer hover:bg-gray-100 transition"
      >
