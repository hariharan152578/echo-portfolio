...
import React, { useState } from 'react'
import axios from 'axios'
import Squares from '../components/Squares'; // 1. Import Squares
    ...
    <div className="relative overflow-hidden bg-white">
      ...
      <div className="relative py-16 px-6 md:px-20">
        ...
        <div className="mt-6 flex justify-center">
          <form
            onSubmit={handleSubmit}
            // Glassmorphism styling for the form
            className="flex flex-col sm:flex-row w-full sm:w-3/4 md:w-1/2 border p-1 rounded-2xl 
                       bg-white/50 backdrop-blur-sm border-white/20 shadow-lg"
          >
            <input
              type="email"
              value={email}
              onChange={(e) => setEmail(e.target.value)}
              // Transparent input
              className="w-full px-5 py-3 border-0 rounded-xl bg-transparent 
