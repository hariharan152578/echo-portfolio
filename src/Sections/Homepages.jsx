...
// // import FluidGlass from '../components/FluidGlass' // Assuming this is in the same folder

// // const Homepages = () => {
// //   const homepageContainerRef = useRef(null)
// //   return (
// //     <>
// //       <div className="flex flex-col relative overflow-visible" ref={homepageContainerRef}>
// //         {/* Background layer - z-0 */}
// //         {/* <FluidGlass containerRef={homepageContainerRef} /> */}
// //         <div className="absolute inset-0 z-10 pointer-events-none"></div>
        
// //         {/* Hero Image - z-0 */}
// //         <div className="absolute right-0 top-0 w-full md:w-1/2 h-full flex justify-center items-center z-0 pointer-events-none">
// //           <div className="relative w-full max-w-[650px] h-[400px] md:h-[600px]">
// //             <img
// //               src={Heroimg}
// //               alt="Hero"
...
// //         {/* FluidGlass component - z-10 (floating on top of background) */}
// //         <div className="absolute inset-0 z-10 pointer-events-none">
// //           <FluidGlass containerRef={homepageContainerRef} />
// //         </div>
        
// //         {/* Hero Section - Content at z-20 (on top of glass) */}
// //         <div className="flex flex-col-reverse md:flex-row justify-between items-center px-6 md:px-20 py-10 relative z-20">
          
// //           {/* Left Text Section */}
// //           <div className="flex flex-col justify-center items-center md:items-start gap-6 text-center md:text-left w-full md:w-1/2 relative z-20">
...
// //           {/* === RIGHT 3D SECTION (MODIFIED) === */}
// //           {/* Spacer for image - image is now in background layer */}
...
// //               {/* Image is now in background layer above */}
// //             </div>
// //           </div>
...
// //         {/* Info Highlights Section - z-20 (on top of glass) */}
// //         <div className="flex flex-col md:flex-row justify-around items-center bg-white py-6 gap-6 md:gap-0 shadow-sm -mt-10 mb-5 relative z-20">
// //           {[
...
// import React, { useRef } from 'react';
// import Heroimg from '../assets/img/Heroimg.png';
// import FluidGlass from '../components/FluidGlass'; // Ensure this path is correct
...
//           <div className="w-full md:w-1/2 flex justify-center mb-8 md:mb-0 relative z-20">
//             <div className="relative w-full max-w-[650px] h-[400px] md:h-[600px] pointer-events-none">
//               {/* This is just a spacer; the image is in the z-0 layer */}
//             </div>
//           </div>
//         </div>
...
import Heroimg from '../assets/img/Heroimg.png'; // Make sure this path is correct

// --- THREE.JS IMPORTS (Required for Ballpit) ---
import {
  Clock as e,
...
// --- BALLPIT COMPONENT LOGIC (Pasted from your prompt) ---
class x {
  #e;
  canvas;
  camera;
...
function S(e) {
  ...
  t.dispose = () => {
    const domEl = e.domElement;
    b.delete(domEl);
    if (b.size === 0) {
      domEl.removeEventListener('pointermove', M);
      domEl.removeEventListener('pointerleave', L);
      domEl.removeEventListener('click', C);

      domEl.removeEventListener('touchstart', TouchStart);
      domEl.removeEventListener('touchmove', TouchMove);
      domEl.removeEventListener('touchend', TouchEnd);
      domEl.removeEventListener('touchcancel', TouchEnd);
...
function TouchStart(e) {
  if (e.touches.length > 0) {
    ...
    if (isTouchingCanvas) e.preventDefault();
  }
}
...
class W {
  ...
  update(e) {
    ...
    if (t.controlSphere0) {
      ...
      // === MODIFIED HERE ===
      // Increased 0.1 to 0.3 for more "sensitive" cursor following.
      // You can increase this value further (up to 1.0) for an instant snap.
...
const Ballpit = ({ className = '', followCursor = true, ...props }) => {
  ...
  return (
    <canvas
      className={`${className} w-full h-full touch-none select-none`}
      ref={canvasRef}
    />
  );
};
  ...
  // duplicate state/resize handler removed here — the Homepages component contains the real hook
    ...
    <>
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <Ballpit
          ...
          wallBounce={1}
          followCursor={true}
          colors={[0x20b15a, 0xffffff, 0xf97316]} // Green, White, Orange
        />
      </div>

        {/* Hero Image - z-10 (MODIFIED from z-0) */}
        <div className="absolute right-0  w-full md:w-1/2 h-full flex justify-center items-center z-10 pointer-events-none">
          <div className="relative w-full max-w-[650px] h-[400px] md:h-[600px]">
            <img
              src={Heroimg}
              alt="Hero"
        ...
        {/* FluidGlass component - REMOVED */}

        {/* Hero Section - Content at z-20 (on top of animation and image) */}
        <div className="flex flex-col-reverse md:flex-row justify-between items-center px-6 md:px-20 py-10 relative z-20">
          {/* Left Text Section */}
          <div className="flex flex-col justify-center items-center md:items-start gap-6 text-center md:text-left w-full md:w-3f/4 relative z-20">
            <h1 className="text-3xl md:text-5xl font-bold text-amber-50 md:text-gray-800   leading-snug">
              Increase Your Customers' Loyalty and Satisfaction
            </h1>
            <p className="font-bold  text-black md:text-gray-700  text-lg md:text-base max-w-md">
              We help businesses like yours earn more customers, stand out from competitors,
              and make more money.
            </p>
            <button className="bg-[#20b15a] text-white px-8 py-3 rounded-md hover:bg-blue-700 transition duration-300 text-sm md:text-base font-semibold mb-5 md:mb-0">
        ...
        {/* Info Highlights Section - z-20 (on top of animation) */}
        <div className="flex flex-col md:flex-row justify-around items-center bg-white py-6 gap-6 md:gap-0 shadow-sm -mt-4 mb-1 relative z-20">
          {[
            'Turning Ideas Into Digital Success',
            'Innovative Solutions for a Digital World',
            'Your Growth is Our Digital Mission',
